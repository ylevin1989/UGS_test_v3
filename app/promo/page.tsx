...
const TEAM = [
    ...
    },
    {
        ...
        desc: "Обеспечивает бессрочный выкуп прав на контент и автоматическую маркировку каждого креатива в ОРД.",
        icon: Scale,
    ...
    return (
        <main className="min-h-screen overflow-x-hidden">
         ...
         ═══════════════════════════════════════ */}
            <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-[#0a0118]/70 border-b border-purple-500/10">
                <div className="container flex items-center justify-between h-16">
                    <span className="font-display text-2xl tracking-wider uppercase gradient-text-aurora">
                        HYPERLIFT
                    </span>
                    <button
                        onClick={scrollToForm}
                        className="btn-aurora px-6 py-2.5 rounded-full text-sm font-bold tracking-wide"
                    >
                        Оставить заявку
                    </button>
                </div>
            ...
            <section className="relative pt-32 pb-20 md:pt-44 md:pb-32 overflow-hidden">
                ...
                <div className="container text-center max-w-5xl mx-auto">
                    ...
                    >
                        ...
                        <br />
                        через доверие к{" "}
                        <span className="gradient-text-violet">UGC</span>
                    </motion.h1>
                    ...
                    >
                        Создаём нативные видео, которые пробивают баннерную слепоту и снижают стоимость привлечения клиента (CAC) до&nbsp;50%.
                    </motion.p>
                        ...
                        <div className="flex justify-center items-end gap-4 md:gap-8">
                            ...
                            <div className="relative w-[36%] max-w-[260px] aspect-[3/4] rounded-2xl md:rounded-3xl overflow-hidden border-2 border-purple-500/30 shadow-2xl shadow-purple-500/20 z-10">
                                ...
                                <div className="absolute bottom-4 left-4 right-4 glass p-3 rounded-xl">
                                    <p className="gradient-text-aurora font-bold text-[10px] md:text-xs tracking-widest uppercase">Живой UGC контент</p>
                                </div>
                            </div>
                            {/* Right phone */}
                ...
                <div className="container">
                    ...
                    >
                        ...
                        <h2 className="font-display text-4xl md:text-7xl lg:text-8xl tracking-tight uppercase leading-[0.9]">
                            Наши{" "}
                            <span className="gradient-text-aurora">Услуги</span>
                        </h2>
                    </motion.div>
                        ...
                        {SERVICES.map((svc, i) => (
                            ...
                            >
                                ...
                                <div className="relative h-48 md:h-56 overflow-hidden">
                                    ...
                                    <div className={`absolute top-4 left-4 w-10 h-10 rounded-xl bg-gradient-to-br ${svc.gradient} flex items-center justify-center text-white shadow-lg`}>
                                        <svc.icon size={20} />
                                    </div>
                                </div>
            ...
            <section className="py-20 md:py-28 section-glow-top relative">
                ...
                <div className="container">
                    ...
                    >
                        ...
                        <h2 className="font-display text-4xl md:text-7xl lg:text-8xl tracking-tight uppercase leading-[0.9]">
                            Наши{" "}
                            <span className="gradient-text-violet">Мастера</span>
                        </h2>
                    </motion.div>
         ...
         ═══════════════════════════════════════ */}
          ...
          MINI FOOTER
         ═══════════════════════════════════════ */}
            <footer className="py-10 border-t border-purple-500/10">
                <div className="container text-center">
                    <span className="font-display text-lg tracking-wider uppercase gradient-text-aurora">
                        HYPERLIFT
                    </span>
